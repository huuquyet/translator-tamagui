...
const APP_TITLE = 'Translator app'
const APP_DESCRIPTION = ' built with Transformers.js + Tamagui, Expo, Next.js & Solito monorepo'
const APP_URL = 'https://tamagui-translator.vercel.app/'
